...
AIO_CHROME_ID = "aceiodigbacjjmffboacmcgfcjemlpbp"; // the chrome app id, the domain has to be verified in this chrome ID dashboard
...
$(document).ready(function(){
    ...
    aioInline.ready(function(err){
        ...
        if(!err){
            ...
            $('ul > li > div.entry .overlay').on('click', function(e){
                e.preventDefault();
                e.stopPropagation();
